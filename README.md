# finance-portfolio
# Finance Portfolio — Suds

Economics student (Mount Carmel College, Bengaluru) building toward 
front-office IB/PWM roles. This repo documents hands-on 
work in financial modeling, valuation, and data analysis as I build 
toward a JP Morgan Summer Analyst application (2027 cycle).

## 📂 Structure

- `/dcf-models` — Discounted cash flow valuations on listed companies
- `/sql-finance-projects` — SQL-based financial data analysis projects.
